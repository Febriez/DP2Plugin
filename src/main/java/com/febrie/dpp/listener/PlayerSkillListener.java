...
public class PlayerSkillListener implements Listener {
                ...
                if (projectile.isOnGround() || projectile.isDead()) {
                    ...
                    try {
                        ...
                        if (parts.length == 3) {
                            ...
                            player.sendMessage("§a좌표로 텔레포트했습니다!");
                            
                            cooldownManager.setCooldown(player, "pants_run");
                        }
                    } catch (NumberFormatException e) {
                        player.sendMessage("§c잘못된 좌표 형식입니다!");
                    }
                    this.cancel();
                }
            }
    ...
    private void startFlyingCarpet(Player player, Minecart minecart) {
    ...
    private void stopFlyingCarpet(Player player) {
    ...
    private void explodeWolf(Wolf wolf) {
